...
;(function($){
    $.fn.pgwSlideshow = function(options) {
        ...
        var finishElement = function(element) {
            ...
            var elementText = '';
            if (element.title) {
                elementText += '<span>' + element.title + '</span>';
            }
            ...
            if (elementText != '') {
                ...
                elementText += '<a href="#" class="red-box">Les mer...</a>';
                elementText += '<p class="news-description">Norske pokerjenter ble til som en gruppe på Facebook i år. Det var undertegnede (Fiona Sand) som ønsket å samle jentene og skape et godt miljø for alle jenter som spiller poker. Vi er få i forhold til </p>';
